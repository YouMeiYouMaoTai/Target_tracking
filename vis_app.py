...
IMAGENET = 'D:/Desktop/graduation_design/SiameseFC/dataset'
DEFAULT_MODEL = 'D:/Desktop/graduation_design/SiameseFC/best.pth.tar'
...
def parse_arguments():
    ...
    # 改变 default=0 的数字，选择视频
    parser.add_argument('-s', '--seq', default=100, dest="seq", type=int,
